    ...
    public abstract class Wordle {
        ...
        public void setAnswerWord(String newAnswer) {
            answer = newAnswer;
        }

        abstract public boolean submitWord(String word);
        abstract public void onWordSubmitted(String[] comparisonResult);
        abstract public void onInvalidWord();
        abstract public void onGameOver(boolean won);
